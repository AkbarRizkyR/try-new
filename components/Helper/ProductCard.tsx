...
const ProductCard = ({ title, image, category, actualPrice, discountPrice }: Props) => {
    return (
        <div>
            ...
            <div className='mt-[1rem] w-[100%] md:w-[90%]'>
                ...
                <div className='mt-[0.3rem] flex items-center justify-between'>
                    <div className='flex items-center space-x-2'>
                        ...
                        <p className='text-[15px] text-white opacity-75'>{discountPrice}</p>
                    </div>
                    <ShoppingBagIcon className='w-[1.2rem] h-[1.2rem] text-orange-500' />
                </div>
            </div>
        </div>
    )
